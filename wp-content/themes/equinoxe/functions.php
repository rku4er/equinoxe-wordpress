...
function html5blank_header_scripts()
{
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
        ...
        wp_register_script('plugins_jquery', get_template_directory_uri() . '/js/plugins.jquery.js', array('jquery'), '1.0.0'); // Custom scripts
        wp_enqueue_script('plugins_jquery'); // Enqueue it!

        wp_register_script('scripts', get_template_directory_uri() . '/js/scripts.js', array('jquery', 'plugins_jquery'), '1.0.0'); // Custom scripts
